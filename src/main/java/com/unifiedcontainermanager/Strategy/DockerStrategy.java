...
import com.unifiedcontainermanager.Exceptions.ApiResponseException;
    ...
    return CompletableFuture.supplyAsync(
        () -> {
          try {
            ...
            throw new com.unifiedcontainermanager.Exceptions.ToolNotFoundException(
                "Container not found: " + containerIdOrName, e);
          } catch (Exception e) {
            logger.error(
    ...
    return CompletableFuture.supplyAsync(
        () -> {
          try {
            ...
            throw new com.unifiedcontainermanager.Exceptions.ToolNotFoundException(
                "Image not found: " + imageIdOrName, e);
          } catch (Exception e) {
