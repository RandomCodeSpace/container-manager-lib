...
/**
 * A testable version of BuildahStrategy that allows for mocking the CLI command execution. This
 * class is used only for testing purposes.
 */
public class TestableBuildahStrategy extends BuildahStrategy {

  private ProcessExecutor.ExecutionResult mockResult;
  private Integer mockExitCode;

  public TestableBuildahStrategy(ProcessExecutor.ExecutionResult mockResult) {
    this.mockResult = mockResult;
  }

  public TestableBuildahStrategy(Integer mockExitCode) {
